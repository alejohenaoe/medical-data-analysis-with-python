...
# 1. mport the data from medical_examination.csv and assign it to the df variable
...
def draw_heat_map():
    ...
    sns.heatmap(corr, mask= mask, square=True, annot=True, fmt='.1f', cmap='Greens', linewidths=.5)
    plt.show()

    # 16. Do not modify the next two line
